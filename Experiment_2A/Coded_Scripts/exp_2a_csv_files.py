...
speed_data_all = np.genfromtxt('speed_data.csv', delimiter=',')
speed_data_3 = speed_data_all[1:, 1:]

# convert speed to time
time_data_3 = speed_data_3
time_data_3[:, 0] = 1.446 / speed_data_3[:, 0]
time_data_3[:, 1] = 0.754 / speed_data_3[:, 1]
time_data_3[:, 2] = 0.906 / speed_data_3[:, 2]
time_data_3[:, 3] = 0.872 / speed_data_3[:, 3]
...
DF_time = pd.DataFrame(time_data_1) 
DF_time.to_csv("T1_data.csv")
DF_time = pd.DataFrame(time_data_2) 
DF_time.to_csv("T2_data.csv")
DF_time = pd.DataFrame(time_data_3) 
DF_time.to_csv("T3_data.csv")
